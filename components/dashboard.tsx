      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-3">
            {/* Industry Switcher - Icon-only, compact placement */}
            <div className="flex items-center gap-0.5 bg-gradient-to-r from-background/95 to-background/85 dark:from-gray-800/95 dark:to-gray-800/85 backdrop-blur-md rounded-full p-0.5 border border-primary/30 dark:border-primary/20 shadow-lg ring-1 ring-primary/10 hover:ring-primary/20 transition-all">
              <button
                onClick={() => handleDashboardTypeChange("retail")}
                className={`relative flex items-center justify-center p-2 rounded-full transition-all duration-300 ease-out group ${
              ...
              >
                <Store className={`h-4 w-4 transition-transform ${dashboardType === "retail" ? "scale-110" : "group-hover:scale-110"}`} />
                {dashboardType === "retail" && (
                  <motion.div
              ...
              <div className="w-px h-6 bg-primary/20 dark:bg-primary/10"></div>
              <button
              ...
              >
                <UtensilsCrossed className={`h-4 w-4 transition-transform ${dashboardType === "restaurant" ? "scale-110" : "group-hover:scale-110"}`} />
                {dashboardType === "restaurant" && (
                  <motion.div
                    layoutId="activeIndicator"
                    className="absolute inset-0 bg-primary rounded-full -z-10"
